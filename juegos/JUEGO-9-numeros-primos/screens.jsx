...
// ─────────────────────────────────────────────────────────────
// Fondo cósmico + glifos de primos flotantes.
// ─────────────────────────────────────────────────────────────
    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          <span style={{ left: "6%", top: "12%", "--rot": "-8deg", fontSize: "0.7em" }}>2</span>
          <span style={{ left: "82%", top: "16%", "--rot": "6deg", fontSize: "0.6em" }}>3</span>
          <span style={{ left: "10%", top: "78%", "--rot": "12deg", fontSize: "0.65em" }}>5</span>
          <span style={{ left: "88%", top: "72%", "--rot": "-10deg", fontSize: "0.6em" }}>7</span>
          <span style={{ left: "45%", top: "8%", "--rot": "4deg", fontSize: "0.55em" }}>11</span>
          ...
          <span style={{ left: "55%", top: "30%", "--rot": "-4deg", fontSize: "0.55em" }}>13</span>
        </div>
      </div>
    );
  }
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        <span style={{ left: "5%", top: "10%", "--rot": "-8deg", fontSize: "0.85em" }}>2</span>
        <span style={{ left: "84%", top: "6%", "--rot": "6deg", fontSize: "0.78em" }}>3</span>
        <span style={{ left: "92%", top: "72%", "--rot": "-12deg", fontSize: "0.74em" }}>5</span>
        <span style={{ left: "3%", top: "82%", "--rot": "12deg", fontSize: "0.78em" }}>7</span>
        <span style={{ left: "46%", top: "4%", "--rot": "-4deg", fontSize: "0.59em" }}>11</span>
        <span style={{ left: "7%", top: "46%", "--rot": "-4deg", fontSize: "0.65em" }}>13</span>
        <span style={{ left: "88%", top: "40%", "--rot": "8deg", fontSize: "0.62em" }}>17</span>
        ...
        <span style={{ left: "50%", top: "88%", "--rot": "4deg", fontSize: "0.55em" }}>19</span>
        <span style={{ left: "40%", top: "38%", "--rot": "-6deg", fontSize: "0.5em" }}>23</span>
      </div>
    </>
  );
}
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    // Juego de nivel único — siempre la categoría "primos".
    // Las 3 rondas dentro del juego escalan internamente por idx
    // (clasificar → discriminar → descomponer) en makeProblem.
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "primos",
      currentCatLabel: "Números primos",
    }));
    go("game");
  }
