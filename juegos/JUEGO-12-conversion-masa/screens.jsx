...
// ─────────────────────────────────────────────────────────────
// Fondo cósmico + glifos de sustituciones (letras, paréntesis).
// ─────────────────────────────────────────────────────────────
    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          <span style={{ left: "6%", top: "12%", "--rot": "-8deg", fontSize: "0.7em" }}>kg</span>
          <span style={{ left: "82%", top: "16%", "--rot": "6deg", fontSize: "0.65em" }}>g</span>
          <span style={{ left: "10%", top: "78%", "--rot": "12deg", fontSize: "0.7em" }}>lb</span>
          <span style={{ left: "88%", top: "72%", "--rot": "-10deg", fontSize: "0.7em" }}>t</span>
          <span style={{ left: "45%", top: "8%", "--rot": "4deg", fontSize: "0.65em" }}>×</span>
          ...
          <span style={{ left: "70%", top: "62%", "--rot": "8deg", fontSize: "0.55em" }}>2,2</span>
  ...
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        <span style={{ left: "5%", top: "10%", "--rot": "-8deg", fontSize: "0.85em" }}>kg</span>
        <span style={{ left: "84%", top: "6%", "--rot": "6deg", fontSize: "0.7em" }}>g</span>
        <span style={{ left: "92%", top: "72%", "--rot": "-12deg", fontSize: "0.78em" }}>lb</span>
        <span style={{ left: "3%", top: "82%", "--rot": "12deg", fontSize: "0.78em" }}>t</span>
        <span style={{ left: "46%", top: "4%", "--rot": "-4deg", fontSize: "0.62em" }}>mg</span>
        <span style={{ left: "7%", top: "46%", "--rot": "-4deg", fontSize: "0.65em" }}>×</span>
        <span style={{ left: "88%", top: "40%", "--rot": "8deg", fontSize: "0.65em" }}>÷</span>
        <span style={{ left: "22%", top: "22%", "--rot": "10deg", fontSize: "0.6em" }}>1000</span>
        <span style={{ left: "70%", top: "24%", "--rot": "-6deg", fontSize: "0.55em" }}>2,2</span>
        <span style={{ left: "32%", top: "70%", "--rot": "8deg", fontSize: "0.55em" }}>=</span>
        <span style={{ left: "62%", top: "78%", "--rot": "-10deg", fontSize: "0.55em" }}>454</span>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          ...
          <div style={{
            ...
            Compara, identifica y convierte masas.
          </div>
...
function CharacterScreen({ app, setApp, go }) {
  const [sel, setSel] = useState(app.character || "numero");
  const current = CHARACTERS.find((c) => c.id === sel) || CHARACTERS[0];

  function choose() {
    // Juego de nivel único — siempre la categoría "sustituciones".
    // Las 3 rondas escalan internamente por idx (sustituciones → paréntesis →
    // sustituciones+paréntesis con numpad) en makeProblem.
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "masa",
      currentCatLabel: "Conversión entre unidades de masa",
    }));
    go("game");
  }
