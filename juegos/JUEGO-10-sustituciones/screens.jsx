    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          <span style={{ left: "6%", top: "12%", "--rot": "-8deg", fontSize: "0.7em" }}>A</span>
          <span style={{ left: "82%", top: "16%", "--rot": "6deg", fontSize: "0.7em" }}>B</span>
          ...
          <span style={{ left: "70%", top: "62%", "--rot": "8deg", fontSize: "0.7em" }}>)</span>
          <span style={{ left: "55%", top: "30%", "--rot": "-4deg", fontSize: "0.5em" }}>1,5</span>
        </div>
      </div>
    );
  }
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        <span style={{ left: "5%", top: "10%", "--rot": "-8deg", fontSize: "0.85em" }}>A</span>
        <span style={{ left: "84%", top: "6%", "--rot": "6deg", fontSize: "0.78em" }}>B</span>
        <span style={{ left: "92%", top: "72%", "--rot": "-12deg", fontSize: "0.78em" }}>C</span>
        <span style={{ left: "3%", top: "82%", "--rot": "12deg", fontSize: "0.78em" }}>D</span>
        <span style={{ left: "46%", top: "4%", "--rot": "-4deg", fontSize: "0.62em" }}>+</span>
        <span style={{ left: "7%", top: "46%", "--rot": "-4deg", fontSize: "0.65em" }}>−</span>
        <span style={{ left: "88%", top: "40%", "--rot": "8deg", fontSize: "0.65em" }}>×</span>
        <span style={{ left: "22%", top: "22%", "--rot": "10deg", fontSize: "0.7em" }}>(</span>
        <span style={{ left: "70%", top: "24%", "--rot": "-6deg", fontSize: "0.7em" }}>)</span>
        <span style={{ left: "32%", top: "70%", "--rot": "8deg", fontSize: "0.55em" }}>÷</span>
        <span style={{ left: "62%", top: "78%", "--rot": "-10deg", fontSize: "0.55em" }}>=</span>
        <span style={{ left: "18%", top: "58%", "--rot": "14deg", fontSize: "0.5em" }}>1,5</span>
        <span style={{ left: "78%", top: "56%", "--rot": "-8deg", fontSize: "0.5em" }}>2,4</span>
        <span style={{ left: "50%", top: "88%", "--rot": "4deg", fontSize: "0.5em" }}>5,3</span>
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    ...
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "sustituciones",
      currentCatLabel: "Operaciones combinadas con números decimales",
    }));
    go("game");
  }
