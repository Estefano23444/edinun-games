...
function GameScreen({ app, setApp, go }) {
  ...
  const bocadilloText = "Ingresa los números correctos.";
  const instructionText = problem.idx === 2 ? "Convierte con litros" : "Convierte la unidad";
  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      {/* Indicador de Ronda — centrado bajo el HUD. */}
      <div style={{
