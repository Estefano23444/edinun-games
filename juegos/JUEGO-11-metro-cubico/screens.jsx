...
// ─────────────────────────────────────────────────────────────
// Fondo cósmico + glifos de masa flotantes (se reusa en todas las
...
function CosmosBg({ variant = "cosmic", glyphSize }) {
  ...
  // DeviceStage a partir del vw/vh defendido contra cambios de DPR.
    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          <span style={{ left: "6%", top: "12%", "--rot": "-8deg", fontSize: "0.6em" }}>m³</span>
          <span style={{ left: "82%", top: "16%", "--rot": "6deg", fontSize: "0.55em" }}>dm³</span>
          <span style={{ left: "10%", top: "78%", "--rot": "12deg", fontSize: "0.55em" }}>L</span>
          <span style={{ left: "88%", top: "72%", "--rot": "-10deg", fontSize: "0.65em" }}>=</span>
          <span style={{ left: "45%", top: "8%", "--rot": "4deg", fontSize: "0.5em" }}>×</span>
          <span style={{ left: "3%", top: "45%", "--rot": "-4deg", fontSize: "0.65em" }}>÷</span>
          <span style={{ left: "92%", top: "45%", "--rot": "8deg", fontSize: "0.55em" }}>cm³</span>
          <span style={{ left: "30%", top: "55%", "--rot": "-6deg", fontSize: "0.5em" }}>1000</span>
          <span style={{ left: "70%", top: "62%", "--rot": "8deg", fontSize: "0.5em" }}>mL</span>
  ...
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        <span style={{ left: "5%", top: "10%", "--rot": "-8deg", fontSize: "0.78em" }}>m³</span>
        <span style={{ left: "84%", top: "6%", "--rot": "6deg", fontSize: "0.7em" }}>dm³</span>
        <span style={{ left: "92%", top: "72%", "--rot": "-12deg", fontSize: "0.74em" }}>cm³</span>
        <span style={{ left: "3%", top: "82%", "--rot": "12deg", fontSize: "0.65em" }}>km³</span>
        <span style={{ left: "46%", top: "4%", "--rot": "-4deg", fontSize: "0.59em" }}>hm³</span>
        <span style={{ left: "7%", top: "46%", "--rot": "-4deg", fontSize: "0.62em" }}>dam³</span>
        <span style={{ left: "88%", top: "40%", "--rot": "8deg", fontSize: "0.65em" }}>mm³</span>
        <span style={{ left: "22%", top: "22%", "--rot": "10deg", fontSize: "0.55em" }}>L</span>
        <span style={{ left: "70%", top: "24%", "--rot": "-6deg", fontSize: "0.55em" }}>mL</span>
        <span style={{ left: "32%", top: "70%", "--rot": "8deg", fontSize: "0.6em" }}>×</span>
        <span style={{ left: "62%", top: "78%", "--rot": "-10deg", fontSize: "0.6em" }}>÷</span>
        <span style={{ left: "18%", top: "58%", "--rot": "14deg", fontSize: "0.5em" }}>1000</span>
        <span style={{ left: "78%", top: "56%", "--rot": "-8deg", fontSize: "0.55em" }}>=</span>
        <span style={{ left: "50%", top: "88%", "--rot": "4deg", fontSize: "0.5em" }}>1</span>
        <span style={{ left: "40%", top: "38%", "--rot": "-6deg", fontSize: "0.55em" }}>?</span>
      </div>
    </>
  );
}
  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      >
        ...
        {/* Columna derecha — entrada + descripción */}
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          ...
          {/* Juego de nivel único — sin chips de dificultad. Descripción del
              juego en su lugar. */}
          <div style={{
            padding: "14px 18px",
            borderRadius: 14,
...
function CharacterScreen({ app, setApp, go }) {
  const [sel, setSel] = useState(app.character || "fisica");
  const current = CHARACTERS.find((c) => c.id === sel) || CHARACTERS[0];

  function choose() {
    // Juego de nivel único — siempre la categoría "volumen".
    // Las 3 rondas dentro del juego escalan internamente por idx
    // (multiplicación → división → equivalencias con litros).
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "volumen",
      currentCatLabel: "Múltiplos y submúltiplos de metro cúbico",
    }));
    go("game");
  }
...
// ─────────────────────────────────────────────────────────────
// 3. MENÚ DE CATEGORÍAS — código residual no enrutado.
// ─────────────────────────────────────────────────────────────
const CATEGORIES = [
