    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          ...
          <span style={{ left: "82%", top: "16%", "--rot": "6deg", fontSize: "0.62em" }}>−</span>
          ...
          <span style={{ left: "92%", top: "45%", "--rot": "8deg", fontSize: "0.58em" }}>9</span>
          <span style={{ left: "30%", top: "55%", "--rot": "-6deg", fontSize: "0.5em" }}>0</span>
  ...
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        ...
        <span style={{ left: "22%", top: "22%", "--rot": "10deg", fontSize: "0.52em" }}>3</span>
        <span style={{ left: "70%", top: "24%", "--rot": "-6deg", fontSize: "0.57em" }}>5</span>
        <span style={{ left: "32%", top: "70%", "--rot": "8deg", fontSize: "0.61em" }}>9</span>
        <span style={{ left: "62%", top: "78%", "--rot": "-10deg", fontSize: "0.63em" }}>0</span>
        <span style={{ left: "18%", top: "58%", "--rot": "14deg", fontSize: "0.48em" }}>7</span>
        <span style={{ left: "78%", top: "56%", "--rot": "-8deg", fontSize: "0.52em" }}>1</span>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          <div>
            <div className="ed-label" style={{ color: "#4fd8ff", marginBottom: 8 }}>
              EDINUN · Operaciones matemáticas
            </div>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr 1fr", gap: 8 }}>
              {[
                { id: "basic", label: "VERTICALES", grad: "linear-gradient(180deg, #ffc06e, #e4881a)", ink: "#3a2608" },
                { id: "medium", label: "HORIZONTALES", grad: "linear-gradient(180deg, #ffe97a, #d7b12a)", ink: "#3a2608" },
                { id: "advanced", label: "CON DECIMALES", grad: "linear-gradient(180deg, #7ab8ff, #2773d8)", ink: "#08264d" },
                { id: "expert", label: "CON ENTEROS", grad: "linear-gradient(180deg, #b48aff, #6f3fe0)", ink: "#1a0a3d" },
              ].map((lv) => {
            ...
            <div style={{
              ...
              {{
                basic: "Sumas y restas de números de 3 cifras",
                medium: "Sumas y restas horizontales de 3 cifras",
                advanced: "Operaciones combinadas con números decimales",
                expert: "Suma y resta de números enteros",
              }[level]}
            </div>
          </div>
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    ...
    //   basic    → suma/resta vertical de 3 cifras
    //   medium   → suma/resta horizontal de 3 cifras
    //   advanced → 4 operaciones (+ − × ÷) con decimales (hasta 3 decimales)
    //   expert   → suma/resta de enteros con signo (resultado puede ser negativo)
