...
// ─────────────────────────────────────────────────────────────
// Fondo cósmico + glifos de operaciones combinadas flotantes.
// ─────────────────────────────────────────────────────────────
    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          <span style={{ left: "6%", top: "12%", "--rot": "-8deg", fontSize: "0.75em" }}>+</span>
          <span style={{ left: "82%", top: "16%", "--rot": "6deg", fontSize: "0.7em" }}>−</span>
          <span style={{ left: "10%", top: "78%", "--rot": "12deg", fontSize: "0.7em" }}>×</span>
          <span style={{ left: "88%", top: "72%", "--rot": "-10deg", fontSize: "0.7em" }}>÷</span>
          <span style={{ left: "45%", top: "8%", "--rot": "4deg", fontSize: "0.5em" }}>1,5</span>
          <span style={{ left: "3%", top: "45%", "--rot": "-4deg", fontSize: "0.5em" }}>2,4</span>
          ...
          <span style={{ left: "55%", top: "30%", "--rot": "-4deg", fontSize: "0.5em" }}>3,2</span>
        </div>
      </div>
    );
  }
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        ...
        <span style={{ left: "92%", top: "72%", "--rot": "-12deg", fontSize: "0.78em" }}>×</span>
        <span style={{ left: "3%", top: "82%", "--rot": "12deg", fontSize: "0.82em" }}>÷</span>
        <span style={{ left: "46%", top: "4%", "--rot": "-4deg", fontSize: "0.55em" }}>1,5</span>
        <span style={{ left: "7%", top: "46%", "--rot": "-4deg", fontSize: "0.5em" }}>2,4</span>
        <span style={{ left: "88%", top: "40%", "--rot": "8deg", fontSize: "0.5em" }}>5,2</span>
        <span style={{ left: "22%", top: "22%", "--rot": "10deg", fontSize: "0.55em" }}>=</span>
        <span style={{ left: "70%", top: "24%", "--rot": "-6deg", fontSize: "0.55em" }}>?</span>
        <span style={{ left: "32%", top: "70%", "--rot": "8deg", fontSize: "0.55em" }}>+</span>
        <span style={{ left: "62%", top: "78%", "--rot": "-10deg", fontSize: "0.5em" }}>···</span>
        <span style={{ left: "18%", top: "58%", "--rot": "14deg", fontSize: "0.5em" }}>3,4</span>
        <span style={{ left: "78%", top: "56%", "--rot": "-8deg", fontSize: "0.5em" }}>0,5</span>
        <span style={{ left: "50%", top: "88%", "--rot": "4deg", fontSize: "0.55em" }}>×</span>
        <span style={{ left: "40%", top: "38%", "--rot": "-6deg", fontSize: "0.5em" }}>7,8</span>
      </div>
    </>
  );
}
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    // Juego de nivel único — siempre la categoría "combinadas".
    // Las 3 rondas escalan internamente por idx (2 ops simples → 2 ops
    // con división → 3 ops mezcladas) en makeProblem.
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "combinadas",
      currentCatLabel: "Operaciones combinadas",
    }));
    go("game");
  }
