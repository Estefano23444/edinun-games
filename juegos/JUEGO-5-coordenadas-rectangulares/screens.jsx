...
// ─────────────────────────────────────────────────────────────
// Fondo cósmico + glifos de coordenadas flotantes.
// ─────────────────────────────────────────────────────────────
    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          <span style={{ left: "6%", top: "12%", "--rot": "-8deg", fontSize: "0.7em" }}>x</span>
          <span style={{ left: "82%", top: "16%", "--rot": "6deg", fontSize: "0.65em" }}>y</span>
          ...
          <span style={{ left: "30%", top: "55%", "--rot": "-6deg", fontSize: "0.5em" }}>A</span>
          <span style={{ left: "70%", top: "62%", "--rot": "8deg", fontSize: "0.5em" }}>0</span>
          <span style={{ left: "55%", top: "30%", "--rot": "-4deg", fontSize: "0.55em" }}>1</span>
        </div>
      </div>
    );
  }
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        <span style={{ left: "5%", top: "10%", "--rot": "-8deg", fontSize: "0.85em" }}>x</span>
        <span style={{ left: "84%", top: "6%", "--rot": "6deg", fontSize: "0.78em" }}>y</span>
        ...
        <span style={{ left: "70%", top: "24%", "--rot": "-6deg", fontSize: "0.65em" }}>0</span>
        <span style={{ left: "32%", top: "70%", "--rot": "8deg", fontSize: "0.6em" }}>1</span>
        <span style={{ left: "62%", top: "78%", "--rot": "-10deg", fontSize: "0.55em" }}>2</span>
        <span style={{ left: "18%", top: "58%", "--rot": "14deg", fontSize: "0.52em" }}>3</span>
        <span style={{ left: "78%", top: "56%", "--rot": "-8deg", fontSize: "0.5em" }}>4</span>
        <span style={{ left: "50%", top: "88%", "--rot": "4deg", fontSize: "0.55em" }}>A</span>
        <span style={{ left: "40%", top: "38%", "--rot": "-6deg", fontSize: "0.5em" }}>B</span>
      </div>
    </>
  );
}
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          <div>
            <div className="ed-label" style={{ color: "#4fd8ff", marginBottom: 8 }}>
              EDINUN · Coordenadas rectangulares
            </div>
          ...
          <div style={{
            ...
            Lee coordenadas y traza caminos.
          </div>
...
function CharacterScreen({ app, setApp, go }) {
  const [sel, setSel] = useState(app.character || "geo");
  const current = CHARACTERS.find((c) => c.id === sel) || CHARACTERS[0];

  function choose() {
    // Juego de nivel único — categoría "coords".
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "coords",
      currentCatLabel: "Sistema de coordenadas rectangulares",
    }));
    go("game");
  }
