  ...
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        ...
        <span style={{ left: "3%", top: "82%", "--rot": "12deg", fontSize: "0.91em" }}>x</span>
        <span style={{ left: "46%", top: "4%", "--rot": "-4deg", fontSize: "0.59em" }}>y</span>
        <span style={{ left: "7%", top: "46%", "--rot": "-4deg", fontSize: "0.67em" }}>0</span>
        ...
        <span style={{ left: "18%", top: "58%", "--rot": "14deg", fontSize: "0.48em" }}>5</span>
        <span style={{ left: "78%", top: "56%", "--rot": "-8deg", fontSize: "0.52em" }}>6</span>
    ...
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          ...
          {/* Sin sección de niveles: este juego es de un solo nivel
              (plano cartesiano cuadrante I, 0..6). En su lugar mostramos
              una breve descripción del juego para que el estudiante sepa
              de qué se trata antes de entrar. */}
          <div style={{
            padding: "12px 16px",
            borderRadius: 14,
            background: "rgba(10,6,35,0.55)",
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    // Juego de un solo nivel: la categoría es siempre la misma.
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "tesoro",
      currentCatLabel: "Plano cartesiano",
    }));
    go("game");
  }
