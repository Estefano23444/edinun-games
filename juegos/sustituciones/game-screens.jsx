...
function GameScreen({ app, setApp, go }) {
  ...
  const bocadilloText = "Reemplaza y resuelve.";
  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      {/* ══════ ZONA CENTRAL — un único contenedor que ocupa todo el alto disponible ══════
          R1/R2: top 88, bottom 18 (sin numpad).
          R3: top 88, bottom 100 (deja sitio al numpad anclado a bottom:14).
          space-evenly reparte el alto entre todos los hijos sin huecos concentrados. */}
