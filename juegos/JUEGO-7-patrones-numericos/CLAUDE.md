...
**Juego: Patrones numéricos.** Carpeta autocontenida del repo
multi-juego `edinun-games`. **Un solo nivel**: 3 ejercicios escalonados
por operación — ronda 1 suma o resta, ronda 2 multiplicación, ronda 3
división. Mecánica única: secuencia con huecos + numpad. Detalle del
diseño en `.planning/patrones-numericos-design.md`.

**Audiencia 9 años** (excepción al default 6-8 del repo, ver
`memory/audiencia_por_juego.md` global). A esta edad ya saben las
tablas de multiplicar; los pasos pueden variar (×2..×5, ÷2..÷5,
±1..±15). **Solo números naturales** (≥ 1) — nunca 0 ni negativos,
y la división nunca produce fracciones (siempre exacta).
