    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          ...
          <span style={{ left: "70%", top: "62%", "--rot": "8deg", fontSize: "0.52em" }}>5</span>
  ...
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        ...
        <span style={{ left: "18%", top: "58%", "--rot": "14deg", fontSize: "0.48em" }}>2</span>
        <span style={{ left: "78%", top: "56%", "--rot": "-8deg", fontSize: "0.52em" }}>3</span>
        <span style={{ left: "50%", top: "88%", "--rot": "4deg", fontSize: "0.5em" }}>5</span>
        <span style={{ left: "40%", top: "38%", "--rot": "-6deg", fontSize: "0.54em" }}>10</span>
      </div>
    </>
  );
}
    ...
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          ...
          {/* Juego de nivel único — sin chips de dificultad. Mostramos una
              descripción del juego para mantener el peso visual de la columna. */}
          <div style={{
            padding: "14px 18px",
            borderRadius: 14,
            background: "rgba(10,6,35,0.55)",
            ...
            Descubre la regla de cada secuencia y completa los números que faltan.
          </div>
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    // Juego de nivel único — siempre la categoría "patrones".
    // Las 3 rondas dentro del juego escalan internamente por idx
    // (suma/resta → multiplicación → división) en makeProblem.
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "patrones",
      currentCatLabel: "Patrones numéricos",
    }));
    go("game");
  }
