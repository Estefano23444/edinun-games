...
**Juego: Fracciones.** Carpeta autocontenida del repo multi-juego
`edinun-games`. Tres niveles: pintar porciones de pizza
(`frac1`), encontrar el numerador equivalente con dos pizzas
(`frac2`, amplificación y simplificación), y representar décimas y
centésimas en barra/cuadrícula con slots de fracción y decimal
(`frac3`). Detalle del diseño en `.planning/fracciones-design.md`.

**Audiencia 9-12 años** (excepción al default 6-8 del repo). Los
denominadores van hasta 12, las centésimas usan slots de 2 dígitos,
y el copy admite vocabulario técnico ("amplifica", "simplifica",
"décimas", "centésimas").
