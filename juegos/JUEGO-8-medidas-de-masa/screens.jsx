    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          <span style={{ left: "6%", top: "12%", "--rot": "-8deg", fontSize: "0.6em" }}>g</span>
          <span style={{ left: "82%", top: "16%", "--rot": "6deg", fontSize: "0.55em" }}>kg</span>
          <span style={{ left: "10%", top: "78%", "--rot": "12deg", fontSize: "0.55em" }}>lb</span>
          ...
          <span style={{ left: "92%", top: "45%", "--rot": "8deg", fontSize: "0.7em" }}>÷</span>
          <span style={{ left: "30%", top: "55%", "--rot": "-6deg", fontSize: "0.5em" }}>10</span>
          <span style={{ left: "70%", top: "62%", "--rot": "8deg", fontSize: "0.5em" }}>100</span>
          <span style={{ left: "55%", top: "30%", "--rot": "-4deg", fontSize: "0.46em" }}>2,2</span>
        </div>
      </div>
    );
  }
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        <span style={{ left: "5%", top: "10%", "--rot": "-8deg", fontSize: "0.78em" }}>g</span>
        <span style={{ left: "84%", top: "6%", "--rot": "6deg", fontSize: "0.7em" }}>kg</span>
        <span style={{ left: "92%", top: "72%", "--rot": "-12deg", fontSize: "0.74em" }}>lb</span>
        <span style={{ left: "3%", top: "82%", "--rot": "12deg", fontSize: "0.65em" }}>dag</span>
        <span style={{ left: "46%", top: "4%", "--rot": "-4deg", fontSize: "0.59em" }}>hg</span>
        ...
        <span style={{ left: "78%", top: "56%", "--rot": "-8deg", fontSize: "0.5em" }}>10</span>
        <span style={{ left: "50%", top: "88%", "--rot": "4deg", fontSize: "0.5em" }}>100</span>
        <span style={{ left: "40%", top: "38%", "--rot": "-6deg", fontSize: "0.5em" }}>2,2</span>
      </div>
    </>
  );
}
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          ...
          <div style={{
            ...
            Medidas de masa y sus múltiplos.
          </div>
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    // Juego de nivel único — siempre la categoría "masa".
    // Las 3 rondas dentro del juego escalan internamente por idx
    // (un escalón → dos escalones → libras) en makeProblem.
    setApp((s) => ({
      ...s,
      character: sel,
      currentCategory: "masa",
      currentCatLabel: "Medidas de masa",
    }));
    go("game");
  }
