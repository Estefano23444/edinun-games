    ...
    return (
      ...
      >
        <div className="ed-glyphs" style={{ color: "rgba(255,255,255,0.10)", ...glyphsStyle }}>
          ...
          <span style={{ left: "3%", top: "45%", "--rot": "-4deg", fontSize: "0.6em" }}>0,5</span>
          <span style={{ left: "92%", top: "45%", "--rot": "8deg", fontSize: "0.58em" }}>0,75</span>
          <span style={{ left: "30%", top: "55%", "--rot": "-6deg", fontSize: "0.5em" }}>/</span>
          <span style={{ left: "70%", top: "62%", "--rot": "8deg", fontSize: "0.52em" }}>0,3</span>
  ...
  return (
    <>
      ...
      <div className="ed-glyphs" style={glyphsStyle}>
        ...
        <span style={{ left: "18%", top: "58%", "--rot": "14deg", fontSize: "0.48em" }}>0,5</span>
        <span style={{ left: "78%", top: "56%", "--rot": "-8deg", fontSize: "0.52em" }}>0,25</span>
        <span style={{ left: "50%", top: "88%", "--rot": "4deg", fontSize: "0.5em" }}>0,75</span>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 22, maxWidth: 520 }}>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: 12 }}>
              {[
                { id: "basic", label: "FRACCIONES", grad: "linear-gradient(180deg, #ffc06e, #e4881a)", ink: "#3a2608" },
                { id: "medium", label: "EQUIVALENTES", grad: "linear-gradient(180deg, #ffe97a, #d7b12a)", ink: "#3a2608" },
                { id: "advanced", label: "DECIMALES", grad: "linear-gradient(180deg, #7ab8ff, #2773d8)", ink: "#08264d" },
              ].map((lv) => {
            ...
            <div style={{
              ...
              {{
                basic: "Reconoce y representa fracciones",
                medium: "Amplifica y simplifica fracciones",
                advanced: "Decimales y fracciones equivalentes",
              }[level]}
            </div>
          </div>
...
function CharacterScreen({ app, setApp, go }) {
  ...
  function choose() {
    ...
    //   básico   → frac1 (pinta porciones de pizza)
    //   medio    → frac2 (amplificar / simplificar fracciones equivalentes)
    //   avanzado → frac3 (décimas y centésimas — fracción y decimal)
    const level = app.level || "basic";
    let catId = "frac1", catLabel = "Fracciones";
    if (level === "medium") {
      catId = "frac2"; catLabel = "Equivalentes";
    } else if (level === "advanced") {
      catId = "frac3"; catLabel = "Decimales y fracciones";
    }
    setApp((s) => ({
      ...s,
      character: sel,
