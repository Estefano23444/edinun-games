...
function GameScreen({ app, setApp, go }) {
  ...
  return (
    <div style={{ position: "absolute", inset: 0, overflow: "hidden" }}>
      ...
      {/* Personaje compañero — esquina inferior izquierda, pequeño */}
      <div style={{
        position: "absolute", left: 8, bottom: 6, width: 160,
        ...
        <div style={{ position: "relative", display: "flex", justifyContent: "center" }}>
          ...
          <char.Component size={140} floating />
        </div>
        <div style={{
          marginTop: -4,
      ...
      {/* Racha / progreso — en el centro superior */}
      <div style={{
        ...
        {[0,1,2].map((i) => (
          <div key={i} style={{
            ...
            background: i < solved ? "#fce9a8" : "rgba(255,255,255,0.2)",
            boxShadow: i < solved ? "0 0 10px #fce9a8" : "none",
          }} />
        ))}
      </div>
